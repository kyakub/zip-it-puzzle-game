export const config = {
    ...
    LEVEL_PARAMS: [
        ...
        { level: 41, rows: 6, cols: 6, xCells: 8, baseCellSize: 65, timeAdd: 5, numWalls: 3, numWaypoints: 0 },
        { level: 61, rows: 6, cols: 6, xCells: 9, baseCellSize: 60, timeAdd: 10, numWalls: 4, numWaypoints: 1 },
